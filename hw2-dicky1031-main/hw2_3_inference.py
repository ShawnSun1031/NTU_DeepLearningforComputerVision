...
if __name__ == '__main__':
    ...
    test_dataset = hw2_3data(test_img_dir, transform=target_transform)
    test_dataloader = DataLoader(test_dataset, batch_size=64, shuffle=False)
       
    
    
    label_predictor = torch.load(target_name+'_predictor_model.pth')
    feature_extractor = torch.load(target_name+'_extractor_model.pth')
    result = []
