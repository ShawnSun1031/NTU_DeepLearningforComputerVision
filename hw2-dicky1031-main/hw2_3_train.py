...
source_dataset = hw2_3data('hw2_data/digits/svhn/train', transform=source_transform)
target_dataset = hw2_3data('hw2_data/digits/svhn/train', transform=target_transform)
test_dataset = hw2_3data('hw2_data/digits/svhn/test', transform=target_transform)
